...
var queueMetrics = []queueMetric{
	...
	{"qbit_jobs_active", "Jobs with a live worker reservation.", "gauge", func(stats qbit.Stats) any { return stats.Active }},
	{"qbit_reservations_expired", "Reservations whose worker lease expired and await recovery.", "gauge", func(stats qbit.Stats) any { return stats.ExpiredReservations }},
	...
	{"qbit_metrics_window_truncated", "Whether the rolling window exceeded the retained metric aggregates.", "gauge", func(stats qbit.Stats) any { return boolValue(stats.WindowMayBeEventTruncated) }},
